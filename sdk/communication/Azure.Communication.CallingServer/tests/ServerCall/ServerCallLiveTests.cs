...
namespace Azure.Communication.CallingServer.Tests
{
    ...
    public class ServerCallLiveTests : CallingServerLiveTestBase
    {
        ...
        public async Task RunAllRecordingFunctionsScenarioTests()
        {
            ...
            {
                IEnumerable<CallConnection> callConnections = new CallConnection[] { };
                try
                {
                    // Establish a Call
                    callConnections = await CreateGroupCallOperation(callingServerClient, groupId, GetFromUserId(), GetToUserId(), TestEnvironment.AppCallbackUrl).ConfigureAwait(false);
